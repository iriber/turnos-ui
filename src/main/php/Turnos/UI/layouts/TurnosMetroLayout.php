...
class TurnosMetroLayout extends RastyLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/TurnosMetroLayout.htm" );
...
// 		$this->addStyle( "$webPath/metro/less/metro-bootstrap.less");
		...
		$this->addStyle( "$webPath/metro/css/turnos.css");
