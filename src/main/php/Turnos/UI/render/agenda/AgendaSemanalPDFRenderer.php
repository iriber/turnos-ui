...
class AgendaSemanalPDFRenderer extends TurnosPDFRenderer{
	...
	protected function renderTurnos(){
		...
		foreach ($turnos as $turno) {
			...
			$this->initFontValue();
			$this->Cell( $maxWidth-30 , 5 , $this->encodeCharactersPDF( "$clienteNombre / $clienteTelefono / Nro HC $clienteHC" ) , 1 , 0 , "L" );
			//$this->Ln(5);
